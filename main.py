...
# from veggie_transformation import veggie_transformation as to_vegan
...
def main():
	...
	parser.add_option('-t', '--transformation', action="store", dest="transformation", help="transformation string", default="chinese")
	...
	if transformation not in ['chinese', 'italian', 'to_vegan', 'from_vegan', 'to_healthy', 'from_healthy', 'to_diy']:
		print("Sorry, please choose one of the following transformations: 'chinese', 'italian', 'to_vegan', 'from_vegan', 'to_healthy', 'from_healthy', 'to_diy'")
		return
